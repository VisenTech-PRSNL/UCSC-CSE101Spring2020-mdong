...
long listIndex(List L);          // Returns index of cursor element if defined, -1 otherwise.
...
long listEquals(List A, List B); // Returns true (1) iff Lists A and B are in same
